...
const SEL = {
    ...
    strategyCaption: '#bottom-area div[class^="backtesting"] [class^="settingGroup"] > div',
    strategyDialogParam: '#bottom-area div[class^="backtesting"]  div[class^="setting"]  > button:nth-child(2)',
